...
* **Tự động cập nhật số dư**: Sau khi người dùng thêm một khoản thu hoặc chi, hệ thống phải tự động tính toán lại số dư của ví đó.
...
* **Việc đóng gói (Containerization)**: Dùng Docker và Docker Compose để "đóng gói" cả 3 phần trên vào các "thùng chứa" tiêu chuẩn, giúp chúng luôn chạy nhất quán ở mọi môi trường.
...
> **Lưu ý:** Ứng viên sau khi hoàn thành bài assignment hãy commit lên tài khoản GitHub cá nhân và gửi repo cho Mr. Phú.
